    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AccomodationRooms", t => t.Room_Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ContentPages", t => t.Page_Id)
                .Index(t => t.Page_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ContentPageVersions", "Page_Id", "dbo.ContentPages");
            ...
            DropForeignKey("dbo.AccomodationRooms", "Venue_Id", "dbo.AccomodationVenues");
            ...
            DropForeignKey("dbo.Beds", "Room_Id", "dbo.AccomodationRooms");
            ...
            DropIndex("dbo.ContentPageVersions", new[] { "Page_Id" });
            ...
            DropIndex("dbo.AccomodationRooms", new[] { "Venue_Id" });
