...
namespace CosPlay.Site.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private async Task SignInAsync(User user, bool isPersistent)
        {
            ...
            var fromIdentity = await AuthenticationManager.GetExternalLoginInfoAsync();
            foreach (var c in fromIdentity.ExternalIdentity.Claims)
            {
                if (!currentClaims.Any(cl => cl.Type == c.Type) && !c.Type.StartsWith("http://schemas.xmlsoap.org/ws/2005/05/identity/claims"))
                {
